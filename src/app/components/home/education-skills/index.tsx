...
const EducationSkills = () => {
  ...
  return (
    <section className="print-page">
      <div className="resume-page border-t border-softGray overflow-hidden">
        <div className="container relative z-10">
          ...
          <div className="relative z-10 py-16 md:py-32">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 xl:gap-20">
              ...
              <div className="grid grid-cols-2 xs:grid-cols-3 gap-5 xl:gap-7 w-full hover:cursor-pointer ">
                {educationData?.skills?.map((value: any, index: any) => {
                  return (
                    <div
                      key={index}
                      className="p-4 xl:p-6 border border-softGray rounded-lg flex flex-col gap-5 sm:gap-10 items-center justify-between hover:bg-orange-600 transition-colors duration-300"
                    >
